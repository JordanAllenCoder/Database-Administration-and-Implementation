...
Oracle database, a separate object called a sequence can be created to generate
...
start with xxxx;--Start with any value larger than the largest value used in the data.
